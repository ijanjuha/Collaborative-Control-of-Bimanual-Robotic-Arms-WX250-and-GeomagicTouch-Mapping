...
bool omni_msgs__msg__omni_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("omni_msgs.msg._omni_state.OmniState", full_classname_dest, 35) == 0);
  }
  omni_msgs__msg__OmniState * ros_message = _ros_message;
  {  // header
  ...
  {  // current
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->current)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of OmniState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("omni_msgs.msg._omni_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OmniState");
  ...
  {  // current
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->current);
    if (!field) {
      return NULL;
    }
    {
