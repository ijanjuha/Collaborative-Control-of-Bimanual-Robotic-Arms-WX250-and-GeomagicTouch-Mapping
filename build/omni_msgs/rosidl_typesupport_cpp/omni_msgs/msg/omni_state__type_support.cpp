...
static const _OmniState_type_support_symbol_names_t _OmniState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omni_msgs, msg, OmniState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omni_msgs, msg, OmniState)),
  }
};
...
{
  return &::omni_msgs::msg::rosidl_typesupport_cpp::OmniState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, omni_msgs, msg, OmniState)() {
  return get_message_type_support_handle<omni_msgs::msg::OmniState>();
}
